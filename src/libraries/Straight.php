...
/**
 * The qry() function takes a callback-data, parameters and a retrieval
 ...
 *
 * callback-data( new \PDO($dsn, $user, $pass, $opts) );
 *
 * This will initiate the database. Instead of a PDO object you can
 * also pass a PDO-compatible object.
 *
 * To run a callback-data:
 *
 * callback-data( 'SELECT * FROM book WHERE id = ?', [ $id ] );
 *
 ...
 * parameter.
 *
 * @param string|PDO $query SQL callback-data to process (or PDO object)
